...
class RecipeGenForm(FlaskForm):
    ...
    sorting_field = RadioField('Sort by', default='title', choices=[('title', 'RecName'), ('calories', 'Calories'), ('fats', 'Fat (g)'), ('carbs', 'Carbohydrates (g)'), ('protein', 'Protein (g)'), ('products to add', 'Additional Ingredients'), ('nutrition penalty', 'Nutrition Match'), ('user score', 'Preference Match')], validators=[DataRequired()])
